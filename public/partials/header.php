...
$academicPages = ['academic-dashboard.php', 'academic-programmes.php', 'academic-courses.php', 'academic-terms.php', 'academic-enrolments.php', 'academic-results.php', 'academic-checksheet.php', 'academic-eligibility.php', 'academic-certificates.php', 'academic-transcripts.php', 'academic-completions.php'];
